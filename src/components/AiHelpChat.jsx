            ...
            <div className="border-t border-gray-100 bg-white px-4 py-3">
              ...
              <form onSubmit={handleSubmit} className="flex items-center gap-2">
                <input
                  ...
                  className="min-w-0 flex-1 rounded-xl border border-gray-200 px-3 py-2 text-sm outline-none transition focus:border-primary-400 focus:ring-2 focus:ring-primary-100"
