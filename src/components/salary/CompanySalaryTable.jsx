...
const CompanySalaryTable = ({ salaries }) => {
      ...
      <table className="w-full border-collapse text-sm">
        <thead>
          <tr className="bg-green-600 text-white">
            ...
            <th className="border border-gray-300 p-2 text-right">Comp Rate</th>
          ...
          {salaries.map((salary, idx) => (
            ...
            >
              ...
              <td className="border border-gray-300 p-2 text-right">
                {formatCurrency(salary.comp_rate)}
              </td>
              <td className="border border-gray-300 p-2 text-right">
...
export default CompanySalaryTable;
